                                ...
                                <div style="border: 1px solid #e9ecef !important; background-color: none !important;"
                                    ...
                                    <button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                        <a href="{{route('agent.create.policies')}}"
                                            class="fa fa-file icon-gradient bg-night-fade btn-icon-wrapper btn-icon-lg mb-3">
                                        </a>
                                        {{__('agent.pages.dashboard.quick_create_police')}}
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-content-left  ml-3 header-user-info">
                            ...
                            <div>
                                    ...
                                    <span class="opacity-10 text-success pr-2">
                                     ...
                                     {{Agent::find(Auth::user()->agent_id)->balance}}
                                    <small class="opacity-5 pl-1">Balance</small>
                                </div>
